...
const Footer = () => {
    return (
        <footer className="bg-primary py-8 px-4 lg:p-14 w-full">
            <div className="container mx-auto max-w-7xl">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div>
                        ...
                        <p className="text-white font-medium my-5">
                            Partner with our experts to enhance your digital
                            footprint.
                            <br /> From SEO to social media, we&apos;ve got you
                            covered.
                        </p>
                        <form action="#" className=" max-w-md">
                            <label
                                htmlFor="email"
                                className="text-sm text-white inline-block mb-2"
                            >
                            ...
                            <div className="mx-auto max-w-screen-sm text-sm text-left text-gray-300">
                                ...
                                <Link
                                    href="/privacy"
                                    className="font-medium underline text-white hover:text-gradient"
                                >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3">
                        <div className="flex flex-col">
                            ...
                            <Link
                                href="/services"
                                className="text-white text-base hover:text-gradient pb-2"
                            >
                                Services
                            </Link>
                            <Link
                ...
                <hr className="mt-8" />
                <small className="text-white mt-8 inline-block">
