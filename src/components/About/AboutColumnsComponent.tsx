            ...
            <div className="py-12 mx-auto max-w-7xl lg:py-16 px-0">
                <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                    ...
                    <p className="mb-5 sm:text-xl">
                        ...
                        drive growth and elevate online presence.
                    </p>
                </div>
                    ...
                    <div className="lg:border-r border-primary">
                        <div>
                            ...
                            <p>
                                ...
                                excellence and customer satisfaction has
                                established us as a trusted partner for
                                businesses looking to enhance their online
                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <p>
                                ...
                                realized it needed a more cohesive digital
                                strategy to maintain its competitive edge. The
                                challenge was to integrate advanced digital
                                marketing techniques while staying true to its
                                core values of innovation and customer
                                satisfaction.
                            </p>
                        </div>
                        <div>
                            ...
                            <p>
                                ...
                                was to align the company&apos;s expanding
                                service offerings with the evolving needs of its
                                diverse client base, ensuring seamless
