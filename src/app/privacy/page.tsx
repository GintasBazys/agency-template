    ...
    return (
        <main className="flex flex-col items-center justify-between p-12 px-4 md:px-24">
            <section className="container max-w-7xl">
                ...
                <p className="mb-4">
                    Your privacy is important to us. It is NovaWave
                    Digital&apos;s policy to respect your privacy regarding any
                ...
                <p className="mb-4">
                    ...
                    do so, such as to provide our services, to communicate with
                    you, or to improve our services.
                </p>
                ...
                <p className="mb-4">
                    We secure your personal information from unauthorized
                    access, use, or disclosure. We use SSL encryption to protect
